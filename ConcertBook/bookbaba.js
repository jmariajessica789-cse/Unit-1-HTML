...
function confirmBooking() {
    ...
    tempBookingData = {
        ...
        amount: total,
        date: "Sun, 1 Feb 2026",
        venue: "D.A.V. BABA SCHOOL, Chennai",
...
function finalizeBooking() {
    if (tempBookingData) {
        // 1. Pack the specific concert data to send to the payment page
        const checkoutData = {
        ...
        // 2. Store in sessionStorage for the payment page to pick up
        sessionStorage.setItem('pendingCheckout', JSON.stringify(checkoutData));

        // 3. Redirect to your existing universal payment page
