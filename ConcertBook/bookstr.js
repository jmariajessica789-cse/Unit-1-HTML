...
function confirmBooking() {
    ...
    tempBookingData = {
        event: "STR Sing Along Night",
        category: categoryName,
        quantity: qty,
        amount: total,
        date: "Sun, 15 Feb 2026",
        venue: "Arangam Art Space, Chennai",
...
// Keep everything else the same, just replace this specific function
function finalizeBooking() {
    if (tempBookingData) {
        // 1. Prepare data for the universal payment page
        const checkoutData = {
        ...
        // 2. Store in sessionStorage so payment.html can read it
        sessionStorage.setItem('pendingCheckout', JSON.stringify(checkoutData));

        // 3. Redirect to your existing payment page
